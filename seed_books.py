...
# # Different book cover images from Unsplash (they will be randomly assigned)
# book_images = [
...
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1542759762-a5e8c2b05232?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1508020976413-b7e7d4b5b9f0?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1543002588-d83cea6bfbff?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1495446815901-a7297e3ffe3d?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1535632066927-ab7cbd9d03ef?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1550744096-a940559753d8?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1491841573634-28db1517c210?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1521995592657-72e98d1b3869?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1510880471819-ef3346c18331?w=300&h=400&fit=crop",
#     "https://images.unsplash.com/photo-1507842217343-583f20270319?w=300&h=400&fit=crop",
# ]

# # Generate 100 unique books with 3 copies each
# for i in range(100):
#     try:
#         # Generate book data
#         title = book_titles[i % len(book_titles)] + (
#             f" - Vol {i // len(book_titles) + 1}" if i >= len(book_titles) else ""
#         )
#         catalog_code = f"BOOK{str(i+1).zfill(5)}"
#         theme = random.choice(themes)
#         publisher = random.choice(publishers)
#         poster = random.choice(book_images)  # Random different image
...
#         if (i + 1) % 10 == 0:
#             print(f"✓ Inserted {i + 1} books with 3 copies each...")
...
# conn.commit()
# print("\n✅ Successfully inserted 100 books with 3 copies each!")
# conn.close()
import sqlite3
from datetime import datetime
import random
